...
/**
 * God class of the selenium API for GoEuro. From here all API methods are invoked.
 * It also starts and closes the Web driver.
 *
 * @author Andrey Klimachev(andre.klim@gmail.com)
 * @since 0.0.1
 */
public class GoEuroSeleniumApi {
    /**
     * Logger.
     */
    private static Logger logger = LoggerFactory.getLogger(GoEuroSeleniumApi.class);

    /**
     * Base url of goeuro page.
     */
    private static final String BASE_URL = "http://www.goeuro.com/";
    ...
    /**
     * Tester object. This object is the endpoint to all tester object that will contain the API to manipulate goeuro page.
     */
    ...
    /**
     * Initializes the GoEuro selenium API: selenium driver and base url.
     */
    public void init() {
        ...
        driver.get(BASE_URL);
        logger.debug("Started web driver for GoEuro.");
    }
    ...
    public enum MachinesTypes {
        ...
        /**
         * Linux machine with phatomsjs.
         */
        LINUX_PHANTOMJS("linux_phantomjs"),
        /**
    ...
    /**
     * Class to handle the parameters of GoEuro selenium API.
     */
    private static class Parameters {
         ...
         * Allowed browsers.
         */
        private String[] allowedBrowsers = {"chrome", "firefox", "phantomjs"};
